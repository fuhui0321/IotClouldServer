...
namespace IotCloudService.IotWebServerWebApi.Models
{
    public enum StatusCodeEnum
    {
        ...
        [Text("未知的用户名和密码")]
        UnknownUserOrPassword = 402,//未授权标识
        ...
        [Text("Token不匹配")]
        TokenCodeError = 408,//HTTP请求不合法

        [Text("增加记录失败")]
        InsertRecordError = 409,//HTTP请求不合法

        [Text("删除记录失败")]
        DeleterecordError = 410,//HTTP请求不合法
